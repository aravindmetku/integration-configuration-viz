...
<div class="flex-strip" style="background-color:#7942a8;height:4.5vh; margin: 2vh 1vw">
    <span  class="purple-strip-border" style="color:#fff; padding: 0.4vw; font-size:0.8rem; border-left: 0.05vw; boder-color: #fff">Total Processors Count : 12 </span>
